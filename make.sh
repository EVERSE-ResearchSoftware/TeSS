...
# Usage:
#   ./make.sh eversetraining <REGISTRY> <USERNAME> <REMOTE_REPO> <TAG>
#   ./make.sh local eversetraining
#   ./make.sh clean
#   ./make.sh re
# ------------------------------------------------------------------------------
...
usage() {
  ...
  echo "  ./make.sh eversetraining <REGISTRY> <USERNAME> <REMOTE_REPO> <TAG>"
  echo "  ./make.sh local eversetraining"
